...
</head><body class="@yield('body-class')">@yield('content')@stack('vendor-scripts')<script src="/js/app.js?v=85" defer></script>@stack('scripts')</body></html>
