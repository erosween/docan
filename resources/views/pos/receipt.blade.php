...
<head>
    ...
    <style>
        *{box-sizing:border-box}body{margin:0;background:#eee;color:#111;font:13px/1.35 ui-monospace,SFMono-Regular,Menlo,monospace}.receipt-tools{position:sticky;top:0;z-index:2;display:flex;justify-content:center;gap:8px;flex-wrap:wrap;padding:12px;background:#292438}.receipt-tools button{border:0;border-radius:9px;padding:10px 14px;font-weight:800}.receipt-tools .print{background:#f5c95f}.receipt-tools .bluetooth{background:#e9f3ff;color:#184d7a}.receipt-tools .bluetooth:disabled{opacity:.65}.printer-status{flex-basis:100%;margin:0;color:#eee;text-align:center;font:11px/1.4 system-ui,sans-serif}.printer-status.error{color:#ffb9b9}.printer-status.success{color:#baf2c7}.receipt{width:58mm;min-height:80mm;margin:18px auto;padding:4mm 3mm;background:#fff}.receipt h1{margin:0;text-align:center;font-size:17px}.receipt .meta{text-align:center;font-size:10px}.rule{margin:8px 0;border-top:1px dashed #111}.item{margin:8px 0}.item b,.item small{display:block}.item small{font-size:10px}.line{display:grid;grid-template-columns:1fr auto;gap:8px}.totals{display:grid;grid-template-columns:1fr auto;gap:4px;font-weight:800}.thanks{text-align:center;margin:22px 0 4px}.receipt.wide{width:80mm}@media print{@page{size:58mm auto;margin:0}body{background:#fff}.receipt-tools{display:none}.receipt{width:58mm!important;margin:0;padding:3mm;box-shadow:none}body.wide-print .receipt{width:80mm!important}@page{margin:0}}
    </style>
</head>
<body>
